...
The fun stuff! All of these tables share a common format: three sets of three columns. The first set of three is the long list, judged on the long list. The second set is the short list, judged on the short list. The last set is the long list, judged on the short list. Likely, the columns of interest are the last three, since they give all possible guesses predicting any reasonable result. The tables show the top 5 performers, where ties are broken by the other scores: ties in yellow-seeking scores are broken by their green-seeking performance and vice-versa. 
