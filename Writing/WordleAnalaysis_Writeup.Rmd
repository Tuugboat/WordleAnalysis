...
```{r Table1, echo=F}
Y_FoF %>% knitr::kable("simple", col.names=c("Word", "Y")) %>% kable_material(c("striped", "hover"))

```

### Short List judge on Short List
```{r Table2, echo=F}
Y_SoS %>% knitr::kable("simple", col.names=c("Word", "Y")) %>% kable_material(c("striped", "hover")) %>% add_header_above(header=c("Kalamazoo"=2))
```

### Full List judged on Short List
```{r Table3, echo=F}
Y_FoS  %>% knitr::kable("simple", col.names=c("Word", "Y")) %>% kable_material(c("striped", "hover"))
```
...
### Full List judged on Full List
```{r Table4, echo=F}
G_FoF %>% knitr::kable("simple", col.names=c("Word", "G")) %>% kable_material(c("striped", "hover"))
```

### Short List judge on Short List
```{r Table5, echo=F}
G_SoS %>% knitr::kable("simple", col.names=c("Word", "G")) %>% kable_material(c("striped", "hover"))
```

### Full List judged on Short List
```{r Table6, echo=F}
G_FoS %>% knitr::kable("simple", col.names=c("Word", "G")) %>% kable_material(c("striped", "hover"))
```
