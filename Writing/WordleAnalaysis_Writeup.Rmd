...
Y_Full %>%
  knitr::kable("simple", col.names=c("Word (FoS)", "Y", "Word (SoS)", "Y", "Word (FoS)", "Y")) %>%
...
G_Full %>%
  knitr::kable("simple", col.names=c("Word (FoS)", "G", "Word (SoS)", "G", "Word (FoS)", "G")) %>%
  kable_material(c("striped", "hover"))
```
...
C_Full %>%
  knitr::kable("simple", col.names=c("Word (FoS)", "C", "Word (SoS)", "C", "Word (FoS)", "C")) %>%
  kable_material(c("striped", "hover"))
```
